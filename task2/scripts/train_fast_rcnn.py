...
from rcnn_experiment.engine.train_fast_rcnn import train_fast_rcnn_model
from rcnn_experiment.utils.io import save_json


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train a teaching-oriented Fast R-CNN detector.")
